...
for images, labels, img_name in kitti_val_loader:
	...
	img_pil.save('/network/tmp1/bhattdha/logs/Full-train-with-new-loss/results/'+str(image_number).zfill(6)+'.png')
	top10pil.save('/network/tmp1/bhattdha/logs/Full-train-with-new-loss/results/'+str(image_number).zfill(6)+'_top10.png')
